...
class ChatConsumer(WebsocketConsumer):
    ...
    def receive(self, text_data=None, bytes_data=None):
        ...
        # Retrieve sender's profile image URL with error handling
        try:
            sender_profile_image_url = sender_user.profile.image_thumbnail_user.url
        except Exception as e:
            # Fallback to a default profile image URL or handle the error accordingly
